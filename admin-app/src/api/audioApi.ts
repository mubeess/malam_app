...
export const fetchAudioReferencesByBookId = async (bookId: number): Promise<AudioReferencesResponse> => {
...
export const createAudioReference = async (audioData: CreateAudioReferenceData): Promise<AudioReference> => {
  const response = await axiosInstance.post<AudioReference>('/audio/add', audioData);
  return response.data;
};

export const updateAudioReference = async (id: number, audioData: Partial<AudioReference>): Promise<AudioReference> => {
